...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    return (
        <>
                ...
                <div className="fixed inset-0  flex">
                    ...
                    >
                        ...
                        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                            ...
                            <nav className="flex flex-1 flex-col bg-red-500">
                                <ul role="list" className="flex flex-1 flex-col gap-y-7">
                                                    ...
                                                    {!item.children ?
                                                        ...
                                                        >
                                                            <item.icon
                                                                aria-hidden="true"
                                                                className={classNames(
                                                                    item.current ? 'text-white dark:text-gray-400' : 'text-gray-400',
                                                                    'h-6 w-6 shrink-0',
                                                                )}
                                                            />
                                                            {item.name}
                                    ...
                                    <li className="mt-auto">
                                        <a
                                            href="#"
                                            className="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-white dark:text-gray-400 hover:bg-gray-50 hover:text-indigo-600"
                                        >
                                            <Cog6ToothIcon
                                                aria-hidden="true"
            ...
            <div className="hidden bg-purple-800 text-white lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col dark:bg-gray-800">
                {/* Sidebar component, swap this element with another sidebar if you like */}
                                        ...
                                        <li key={item.name}>
                                            {!item.children ?
                                                ...
                                                <Disclosure as="div">
                                                    ...
                                                    >
                                                        <item.icon aria-hidden="true" className="h-6 w-6 shrink-0 text-white" />
                                                        {item.name}
                                                        <ChevronRightIcon
                                                            aria-hidden="true"
                                                            className="ml-auto h-5 w-5 shrink-0 text-gray-400 group-data-[open]:rotate-90 group-data-[open]:text-gray-500"
